...
- The slope of the linear model is not 0.  With reviewing multiple coefficients in our linear regression model we analyze the p-value to determine the slope (m) of the variable. With the significance of our p-value being much smaller than our assumed significant level of 0.05% the slope of the linear model is not zero and we can reject the null hypothesis.
